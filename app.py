...
from models import db, User, Download, Subscription, Feedback, UserSettings, SiteStats
...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'viddy-downloader-secret-key-change-in-production'
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///viddy.db'
